const template = `
<div class="bg-gray-100" cz-shortcut-listen="true" data-new-gr-c-s-check-loaded="14.1106.0" data-gr-ext-installed="">
   <section class="py-10 md:py-16">
      <div class="container max-w-screen-xl mx-auto px-4">
         <nav class="flex items-center justify-between mb-40">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/navbar-logo.png" alt="Logo">
         ...
         <div class="text-center">
            <div class="flex justify-center mb-16">
               <img src="https://elegant-goodies.co/preview/Porto/assets/image/home-img.png" alt="Image">
            </div>
         ...
         <div class="flex flex-col lg:flex-row justify-between">
            ...
            <div class="space-y-24">
               <div class="flex space-x-6">
                  ...
                  <span class="w-28 h-1 bg-gray-300 mt-5"></span>
                  <div>
   ...
   <section class="py-10 md:py-16">
      <div class="container max-w-screen-xl mx-auto px-4">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-1.png" alt="Image">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-2.png" alt="Image">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-3.png" alt="Image">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-4.png" alt="Image">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-5.png" alt="Image">
            <img src="https://elegant-goodies.co/preview/Porto/assets/image/brand-6.png" alt="Image">
         </div>
      </div>
   </section>
   <section class="py-10 md:py-16">
         ...
         <div class="text-center">
            ...
            <div class="flex items-center justify-center space-x-8">
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter text-gray-500 hover:text-gray-800 transition ease-in-out duration-500">
                     <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
                  </svg>
               </a>
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dribbble text-gray-500 hover:text-gray-700 transition ease-in-out duration-500">
                     <circle cx="12" cy="12" r="10"></circle>
                     <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72m2.54-15.38c-3.72 4.35-8.94 5.66-16.88 5.85m19.5 1.9c-3.5-.93-6.63-.82-8.94 0-2.58.92-5.01 2.86-7.44 6.32"></path>
                  </svg>
               </a>
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook text-gray-500 hover:text-gray-700 transition ease-in-out duration-500">
                     <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                  </svg>
               </a>
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-codepen text-gray-500 hover:text-gray-700 transition ease-in-out duration-500">
               ...
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-at-sign text-gray-500 hover:text-gray-700 transition ease-in-out duration-500">
                     <circle cx="12" cy="12" r="4"></circle>
                     <path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path>
                  </svg>
               </a>
               <a href="#" class="w-16 h-16 flex items-center justify-center rounded-full hover:bg-gray-200 transition ease-in-out duration-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram text-gray-500 hover:text-gray-700 transition ease-in-out duration-500">
