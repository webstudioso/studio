const template = `
  <div id="i78z-2" data-new-gr-c-s-check-loaded="14.1138.0" data-gr-ext-installed="" cz-shortcut-listen="true">
        ...
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p class="mb-8 leading-relaxed">
              <span id="ibfry7" class="lg:text-lg">Join us in 2024 as we Engineer Ireland's Tech Culture | Dogpatch Labs, CHQ | 24th - 26th May, 2024!</span>
            </p>
...
`
const metadata = {
   image: 'https://i.ibb.co/jMcqcT3/ETHDublin-Main.png',
