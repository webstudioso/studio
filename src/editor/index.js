...
import Upgrade from '../views/modal/UpgradeModal'
...
const Editor = ({ project, principal }) => {
  ...
  const loadEditor = () => {
    ...
    const editor = grapesjs.init({
      ...
      canvas: {
        scripts: [
          "https://cdn.jsdelivr.net/npm/webstudio-sdk@1.0.14/dist/main.min.js",
    ...
    // Storage events
    editor.on('storage:start:load', () => dispatch({ type: LOADER, show: true }))

    editor.on('storage:end:load', () => dispatch({ type: LOADER, show: false }))
